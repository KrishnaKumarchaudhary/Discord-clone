...
const postInvite = async (req, res) => {
  ...
  //check if freind that we would like to invite is not user
  ...
  // if check invitation has been already sent

  const invitationAlreadyRecevied = await FriendInvitation.findOne({
    senderId: userId,
    receiverId: targetUser._id,
  });

  if (invitationAlreadyRecevied) {
